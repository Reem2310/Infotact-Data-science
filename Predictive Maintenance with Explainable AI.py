...
plt.title(f"Local Explanation for Test Instance {risk_idx}")
plt.tight_layout()
plt.savefig(f"{OUTPUT_DIR}/shap_local_explanation.png")
plt.close()

print(f"Local explanation saved for Test Instance {risk_idx}.")